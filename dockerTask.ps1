...
.PARAMETER Clean
Removes the image trend_to_ascend and kills all containers based on that image.
...
Build a Docker image named trend_to_ascend
#>
...
$imageName="trend_to_ascend"
$projectName="trendtoascend"
$publicPort=3000
